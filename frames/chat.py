...
messages = [{"message": "Hello Python!", "date": 15498487}]
message_labels = []
...
class Chat(ttk.Frame):
    def __init__(self, container, background, **kwargs):
        ...
        self.message_window.grid(row=0, column=0, sticky="NESW", pady=5)
    ...
    def get_messages(self):
        ...
        self.message_window.update_message_widgets(messages, message_labels)
        self.after(100, lambda: self.message_window.yview_moveto(1.0))